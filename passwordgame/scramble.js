...
function drawPlane(x, y) {
    ...
    if (planeDirection == "left") {
        planeImg = document.getElementById("planeLeftImage");
    } else {
        planeImg = document.getElementById("planeRightImage");
    }

    ctx.drawImage(planeImg, x, y, planeWidth, planeHeight);
}
...
function drawBackground() {
    ...
    grd.addColorStop(0,"#EA2326");
    grd.addColorStop(1,"#EA2326");
    ctx.fillStyle=grd;
    ...
    ctx.fillText("Breaker", canvasWidth * 0.080, canvasHeight * 0.16);
...
function setScale() {
    ...
    planeWidth = Math.round (canvasWidth / 7.5);
    planeHeight = Math.round (planeWidth / 2.5);
    ...
    planeY = Math.round(canvasHeight / 6);

    playerSpeed = canvasWidth * redrawInterval * playerSpeedBaseline / 10000;
    planeSpeed = canvasWidth * redrawInterval * planeSpeedBaseline / 10000;
...
function genCharacter () {
    ...
    if (planeDirection == "right") {
        char.x = planeX - planeWidth * 0.1;
    } else {
        char.x = Math.round(planeX + planeWidth * 0.9);
    }
    ...
    char.y = Math.round(planeY + planeHeight / 2);
...
function redrawScreen () {
    ...
    if (planeDirection == "right" && planeX < canvasWidth) {
        planeX += planeSpeed;
    } else if (planeDirection == "left" && planeX > -planeWidth) {
        planeX -= planeSpeed;
    }

    if (planeX >= canvasWidth) {
        planeDirection = "left";
    } else if (planeX <= -planeWidth) {
...
function drawSplashScreen () {
    ...
    ctx.font = charWidth + "px Courier New";
    ctx.fillText("Password Game", canvasWidth * 0.32, canvasHeight * 0.2);
    ...
    if (gameLevel == 1) {
        ...
        ctx.fillText("It's your first day at Brooklyn College!", canvasWidth * 0.5, canvasHeight * 0.42);
        ...
        ctx.fillText(" New semester your password is nearly 55 days old.", canvasWidth * 0.48, canvasHeight * 0.42);
    ...
    ctx.fillText("Make the strongest possible password before the Password Breaker can break it.", canvasWidth * 0.22, canvasHeight * 0.65);
